...
@section('content')
    <form action='{{route("admin.pages.do_edit", ["id" => $page->id])}}' method="post" enctype="multipart/form-data">
        @csrf
        <div class="x_panel">
            <div class="x_title">
                ...
                <div class="pull-right mt-2 mr-2">
                    <div class="">
                        <label>
                            <input type="checkbox" class="js-switch" name='is_active' id='is_active' value='1' @if($page->is_active) checked @endif /> Active page
                        </label>
                    </div>
                </div>
