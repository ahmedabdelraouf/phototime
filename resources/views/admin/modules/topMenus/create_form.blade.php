<div class="row">
    <div class="col-12 col-md-6 col-lg-6">
        <div class="form-group">
            ...
            <input type='text' name='title_{{$form_lang}}' id='title_{{$form_lang}}' value='{{old("title_$form_lang")}}' placeholder="Menu Title ({{strtoupper($form_lang)}})"
    ...
    <div class="col-12 col-md-6 col-lg-6">
        <div class="form-group">
            ...
            <input type='text' name='a_title_{{$form_lang}}' id='a_title_{{$form_lang}}' value='{{old("a_title_$form_lang")}}' placeholder="Menu URL Tag Title ({{strtoupper($form_lang)}})"
...
<div class="row">
    <div class="col-12 col-md-9 col-lg-9">
        <div class="form-group">
            ...
            <input type='text' name='url_{{$form_lang}}' id='url_{{$form_lang}}' value='{{old("url_$form_lang")}}' placeholder="Menu Link ({{strtoupper($form_lang)}})"
