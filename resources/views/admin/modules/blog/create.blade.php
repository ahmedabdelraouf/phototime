...
@section('content')
    <form action='{{route("admin.blog.do_create")}}' method="post" enctype="multipart/form-data">
        @csrf
        <div class="x_panel">
            <div class="x_title">
                <h2>Add Blog Page</h2>
                    <a class="btn btn-danger btn-round btn-xs pull-right" title="Cancel Add page" href="{{route("admin.blog.list")}}">
                        <i class="fa fa-angle-double-right"></i>
                    </a>
                <div class="pull-right mt-2 mr-2">
                    <div class="">
                        <label>
                            <input type="checkbox" class="js-switch" name='is_active' id='is_active' value='1' /> Active Blog Page
                        </label>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="form-group">
                            ...
                            <input type='text' name='title' id='title' value='{{old("title")}}' placeholder="Blog Page Title"
                    ...
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="form-group">
                            ...
                            <input type='text' name='slug' id='slug' value='{{old("slug")}}' placeholder="Blog Page unique slug"
                ...
                <div class="row" style="margin-top: 2%">
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="form-group">
                            ...
                            <input type='text' name='meta_title' id='meta_title' value='{{old("meta_title")}}' placeholder="Blog Page Meta Title"
            ...
            ></textarea>
                ...
                <div class="row mb-3">
                    <div class="col-6 col-md-6 col-lg-6">
                        <div class="form-group">
                            <label for="image" class="form-label @if ($errors->has("image")) is-invalid @endif">Image</label>
