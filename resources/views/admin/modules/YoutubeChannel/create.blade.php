...
@section('youtubeChannel-active')
    active current-page
@endsection


@section('content')
    <form action='{{route("admin.youtubeChannel.do_create")}}' method="post" enctype="multipart/form-data">
        @csrf
        <div class="x_panel">
            <div class="x_title">
                <h2>Add youtube Channel Link</h2>
                <a class="btn btn-danger btn-round btn-xs pull-right" title="Cancel Add slider"
                   href="{{route("admin.youtubeChannel.list")}}">
            ...
            <div class="x_content"
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-4 col-lg-4">
                        <div class="form-group">
                            <label for="url" class="form-label @if ($errors->has("url")) is-invalid @endif">Video Link</label>
                            <input type='text' name='url' id='url' value='{{old("url")}}' placeholder="Video Link"
