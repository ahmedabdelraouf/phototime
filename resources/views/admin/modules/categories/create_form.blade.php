<div class="row">
    <div class="col-12 col-md-6 col-lg-6">
        <div class="form-group">
            ...
            <input type='text' name='title_{{$form_lang}}' id='title_{{$form_lang}}' value='{{old("title_$form_lang")}}' placeholder="Category Title ({{strtoupper($form_lang)}})"
    ...
    <div class="col-12 col-md-6 col-lg-6">
        <div class="form-group">
            ...
            <input type='text' name='slug_{{$form_lang}}' id='slug_{{$form_lang}}' value='{{old("slug_$form_lang")}}' placeholder="Category unique slug"
                   class='form-control slug_input @if ($errors->has("slug_$form_lang")) is-invalid @endif'
                   aria-slugedBy="title_{{$form_lang}}" {{ $required }}
...
<div class="row" style="margin-top: 2%">
    <div class="col-12 col-md-6 col-lg-6">
        <div class="form-group">
            ...
            <input type='text' name='meta_title_{{$form_lang}}' id='meta_title_{{$form_lang}}' value='{{old("meta_title_$form_lang")}}' placeholder="Category Meta Title ({{strtoupper($form_lang)}})"
