...
@section('content')
    <div class="col-md-12 col-sm-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>List Category</h2>
                <a class="btn btn-primary btn-round btn-xs pull-right" title="Add new category" href="{{route("admin.categories.create")}}">
            ...
            <div class="x_content" style="padding-top: 0.2rem !important;">
                <div class="table-responsive">
                    <table  class="table table-hover table-striped">
                            ...
                            <tr>
                                ...
                                <td class='text-center'>
                                    <div class="btn-group">
                                        ...
                                        @endif
                                        <a href="{{route("admin.categories.edit", ["id" => $category->id])}}" class="mx-2" data-bs-toggle="tooltip" data-bs-original-title="Edit category"
                                           title="Edit category">
                        ...
                        @empty
                            <tr>
                                <td colspan="100%"><h4 style="width: 100%;color:#ff0000;text-align: center">No Categories added</h4></td>
                            </tr>
                        @endforelse
                        </tbody>
                    </table>
