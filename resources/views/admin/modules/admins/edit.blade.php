        ...
        <div class="x_panel">
            <div class="x_title">
                ...
                <div class="pull-right mt-2 mr-2">
                    <div class="">
                        <label>
                            <input type="checkbox" class="js-switch" name='is_active' id='is_active' value='1' @if($admin->is_active) checked @endif /> Active page
                        </label>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="form-group">
                            <label for="name" class="form-label @if ($errors->has("name")) is-invalid @endif">Page name</label>
                            <input type='text' name='name' id='name' value='{{old("name",$admin->name)}}' placeholder="Page name"
                    ...
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="form-group">
                            ...
                            <input type='text' name='email' id='email' value='{{old("email",$admin->email)}}' placeholder="Admin email"
                    ...
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="form-group">
                            ...
                            <select name="role_id" class="form-control"  id="parent_role">
