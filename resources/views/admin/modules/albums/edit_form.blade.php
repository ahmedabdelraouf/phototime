<div class="row">
    <div class="col-12 col-md-12 col-lg-12">
        <div class="form-group">
            ...
            <input type='text' name='title_{{$form_lang}}' id='title_{{$form_lang}}' value='{{old("title_$form_lang", $album->{'title_'.$form_lang})}}' placeholder="Album Title ({{strtoupper($form_lang)}})"
    ...
    <div class="col-6 col-md-6 col-lg-6">
        <div class="form-group">
            ...
            <input type='text' name='menu_title' id='menu_title' value='{{old("menu_title", $album->menu_title)}}' placeholder="Menu Title"
    ...
    <div class="col-12 col-md-6 col-lg-6">
        <div class="form-group">
            ...
            <input type='text' name='slug_{{$form_lang}}' id='slug_{{$form_lang}}' value='{{old("slug_$form_lang", $album->{'slugData'.ucfirst($form_lang)}->slug)}}' placeholder="Album unique slug"
...
<div class="row" style="margin-top: 2%">
    <div class="col-12 col-md-6 col-lg-6">
        <div class="form-group">
            ...
            <textarea name="short_desc_{{$form_lang}}" id="short_desc_{{$form_lang}}"
                      ...
                      aria-invalid="true"
                @endif
            >{{old("short_desc_$form_lang", $album->{'short_desc_'.$form_lang})}}</textarea>
            @if ($errors->has("short_desc_$form_lang"))
    ...
    <div class="form-group">
        ...
        <textarea name="meta_keywords_{{$form_lang}}" id="meta_keywords_{{$form_lang}}"
                  ...
                  aria-invalid="true"
                @endif
            >{{old("meta_keywords_$form_lang", $album->{'meta_keywords_'.$form_lang})}}</textarea>
        @if ($errors->has("meta_keywords_$form_lang"))
...
<div class="row" style="margin-top: 2%">
    <div class="col-12 col-md-6 col-lg-6">
        <div class="form-group">
            ...
            <input type='text' name='meta_title_{{$form_lang}}' id='meta_title_{{$form_lang}}' value='{{old("meta_title_$form_lang", $album->{'meta_title_'.$form_lang})}}' placeholder="Album Meta Title ({{strtoupper($form_lang)}})"
    ...
    <div class="col-12 col-md-6 col-lg-6">
        <div class="form-group">
            ...
            <textarea name="meta_description_{{$form_lang}}" id="meta_description_{{$form_lang}}"
                      ...
                      aria-invalid="true"
                @endif
            >{{old("meta_description_$form_lang", $album->{'meta_description_'.$form_lang})}}</textarea>
            @if ($errors->has("meta_description_$form_lang"))
    ...
    <div class="col-12 col-md-12">
        <div class="form-group">
            ...
            <textarea name="content_{{$form_lang}}" id="content_{{$form_lang}}"
                      ...
                      aria-invalid="true"
                @endif
            >{{old("content_$form_lang", $album->{'content_'.$form_lang})}}</textarea>
            @if ($errors->has("content_$form_lang"))
