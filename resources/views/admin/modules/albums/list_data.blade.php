...
@section('content')
    <div class="col-md-12 col-sm-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>List Album</h2>
                <a class="btn btn-primary btn-round btn-xs pull-right" title="Add new album" href="{{route("admin.albums.create")}}">
                            ...
                            <tr>
                                ...
                                <td class='text-center'>
                                    <div class="btn-group">
                                        ...
                                        @endif
                                        <a href="{{route("admin.albums.edit", ["id" => $album->id])}}" class="mx-2" data-bs-toggle="tooltip" data-bs-original-title="Edit album"
                                           title="Edit album">
