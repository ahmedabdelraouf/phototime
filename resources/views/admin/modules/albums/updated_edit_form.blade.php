        ...
        <div class="col-12 col-md-6 col-lg-6 mb-3">
            <div class="form-group">
                ...
                <input type='file' accept="image/x-png,image/gif,image/jpeg" name='default_image'
                       id='default_image'
                       placeholder="image"
                       class='form-control @if ($errors->has("default_image")) is-invalid @endif'
                ...
                <div class="col-12 col-md-12">
                    <div class="form-group">
                                    <textarea name="short_desc" id="content"
                                              ...
                                              aria-invalid="true" @endif>{{$album->short_desc}}</textarea>
                        @if ($errors->has("short_desc"))
