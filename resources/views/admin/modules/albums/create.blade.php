        ...
        <div class="x_panel">
            <div class="x_title">
                ...
                <div class="pull-right mt-2 mr-2">
                    <div class="">
                        <label>
                            <input type="checkbox" class="js-switch" name='is_active' id='is_active' value='1' /> Active album
                        </label>
                    </div>
                </div>
            ...
            <div class="x_content" style="padding-top: 0.2rem !important;">
                ...
                <div class="row mb-3">
                    <div class="col-6 col-md-6">
                        <div class="form-group">
                            <label for="categories" class="mt-4 form-label @if ($errors->has("categories[]")) is-invalid @endif">Categories</label>
                            <select class="form-control select2_multiple @if ($errors->has("categories[]")) is-invalid @endif"
                                    id="categories" name="categories[]" multiple data-placeholder="Choose one thing" required
                            ...
                            @if ($errors->has("categories[]"))
                                <div id="categories-error" class="invalid-feedback animated fadeInDown">{{ $errors->first("categories[]") }}</div>
                            @endif
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-6 mb-3">
                        <div class="form-group">
                            <label for="title" class="form-label @if ($errors->has("title")) is-invalid @endif">Album Title</label>
                            <input type='text' name='title' id='title' value='{{old("title")}}' placeholder="Album Title"
                    ...
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="form-group">
                            <label for="slug" class="form-label @if ($errors->has("slug")) is-invalid @endif">Album slug</label>
                            <input type='text' name='slug' id='slug' value='{{old("slug")}}' placeholder="Album unique slug"
                ...
                <div class="row">
                    <div class="col-12 col-md-4 col-lg-4 mb-3">
                        <div class="form-group">
                            <label for="photo_date" class="form-label @if ($errors->has("photo_date")) is-invalid @endif">Album Date</label>
                            <input type='date' name='photo_date' id='photo_date' value='{{old("photo_date")}}' placeholder="Album Date"
                            ...
                            />
                            @if ($errors->has("photo_date"))
                                <div id="photo_date-error" class="invalid-feedback animated fadeInDown">{{ $errors->first("photo_date") }}</div>
                            @endif
                        </div>
                    </div>
                    <div class="col-12 col-md-4 col-lg-4 mb-3">
                        <div class="form-group">
                            <label for="photo_owner_name" class="form-label @if ($errors->has("photo_owner_name")) is-invalid @endif">Album Owner name</label>
                            <input type='text' name='photo_owner_name' id='photo_owner_name' value='{{old("photo_owner_name")}}' placeholder="Album Owner name"
                                   class='form-control @if ($errors->has("photo_owner_name")) is-invalid @endif' required
                            ...
                            />
                            @if ($errors->has("photo_owner_name"))
                                <div id="photo_owner_name-error" class="invalid-feedback animated fadeInDown">{{ $errors->first("photo_owner_name") }}</div>
                            @endif
                        </div>
                    </div>
                    <div class="col-12 col-md-4 col-lg-4 mb-3">
                        <div class="form-group">
                            <label for="photo_place" class="form-label @if ($errors->has("photo_place")) is-invalid @endif">Address</label>
                            ...
                            @if ($errors->has("photo_place"))
                                <div id="photo_place-error" class="invalid-feedback animated fadeInDown">{{ $errors->first("photo_place") }}</div>
                            @endif
                        </div>
                    </div>
                </div>
            ...
            ></textarea>
                ...
                <div class="row" style="margin-top: 2%">
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="form-group">
                            <label for="meta_title" class="form-label @if ($errors->has("meta_title")) is-invalid @endif">Meta Title for the album</label>
                            <input type='text' name='meta_title' id='meta_title' value='{{old("meta_title")}}' placeholder="Album Meta Title "
