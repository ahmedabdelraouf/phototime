<div id="last-work">
    ...
    <br>
    <div class="container">
        <h4 class="m-0 text-light pt-3 text-center">
            <img src="{{asset('resources/site/images/hash-left.svg')}}" alt="left hash"/>
            تغطيات عامة
            <img src="{{asset('resources/site/images/hash-right.svg')}}" alt="right hash"/>
        </h4>
...
{{--            </div>--}}
    ...
    <br>
    <div class="container">
        <h4 class="m-0 text-dark pt-3 text-center">
            <img src="{{asset('resources/site/images/hash-left.svg')}}" alt="left hash"/>
            ليلة العمر
            <img src="{{asset('resources/site/images/hash-right.svg')}}" alt="right hash"/>
        </h4>
...
{{--            </div>--}}
        ...
        <div class="text-center show-more">
            <button onclick="window.location.href='{{route('site.albums',["album_title"=>"حفل زواج"])}}'">عرض المزيد</button>
        </div>
    </div>
