...
Route::get("/syncDefaultImages", [MeController::class, "syncDefaultImages"])->name("syncDefaultImages");
...
Route::prefix("albums")->as("albums.")->middleware("should_login")->group(function () {
    ...
    Route::get("update-public-status/{type}/{id}", [AlbumsController::class, "updatePublicStatus"])->name("update_public_status");
